            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" id="ibox_form">
                    ...
                    <form class="form-horizontal" method="post" id="eform" role="form">
                        ...
                        <div class="form-group">
                            <label for="payer" class="col-md-3 control-label">{$_L['Payer']}</label>
                            <div class="col-md-9">
                                <select id="payer" name="payer" class="form-control" style="width:100%">
                                    {if $val['customer']}
                        ...
                        <input type="hidden" name="did" id="did" value="{$val['id']}" />
                        <input type="hidden" name="firstdeposit_flag" value="{$firstdeposit_flag}" />
                    </form>
...
<div class="modal-footer">
    ...
    <button type="submit" class="btn btn-primary deposit_submit" id="deposit_submit">
