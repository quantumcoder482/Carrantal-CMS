        ...
        <div class="col-lg-8">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>
                        {$_L['Add Vehicle Product']}
                    </h5>
                    <div class="ibox-tools">
                      
                            <a href="{$_url}ps/v-list" class="btn btn-primary btn-xs">{$_L['List Products']}</a>
                ...
                <div class="ibox-content" id="ibox_form">
                    ...
                    <form class="form-horizontal" id="rform">
                        ...
                        <div class="form-group"><label class="col-lg-2 control-label" for="vehicle_type">{$_L['Select Vehicle']}</label>
