                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <a class="dashboard-stat blue" href="{$_url}transactions/deposit/">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            <span class="amount" data-a-sign="{$currency->symbol} ">{$total_expense_all_time}</span>
                                        </div>
                                        <div class="desc"> {$_L['Total Expense']} </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a class="dashboard-stat blue" href="{$_url}transactions/deposit/">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            <span class="amount" data-a-sign="{$currency->symbol} ">{Transaction::totalAmount('Expense',$currency->id,'current_month')}</span>
                                        </div>
                                        <div class="desc"> {$_L['Total Expense This Month']} </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a class="dashboard-stat blue" href="{$_url}transactions/deposit/">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            <span class="amount" data-a-sign="{$currency->symbol} ">{Transaction::totalAmount('Expense',$currency->id,'current_week')}</span>
                                        </div>
                                        <div class="desc"> {$_L['Total Expense This Week']} </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a class="dashboard-stat blue" href="{$_url}transactions/deposit/">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            <span class="amount" data-a-sign="{$currency->symbol} ">{Transaction::totalAmount('Expense',$currency->id,'last_30_days')}</span>
                                        </div>
                                        <div class="desc"> {$_L['Total Expense Last 30 days']} </div>
                                    </div>
                                </a>
                            </div>
                        </div>
