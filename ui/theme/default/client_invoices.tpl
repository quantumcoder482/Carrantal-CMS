                    ...
                    <div class="row" id="d_ajax_summary">
                        ...
                        <div class="col-md-4">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                <tr><td>Paid: </td> <td><span class="amount">{$total_paid_amount}</span> </td></tr>
                                <tr><td>Unpaid: </td> <td><span class="amount">{$total_unpaid_amount}</span> </td></tr>
                                <tr><td>Partially Paid: </td> <td><span class="amount">{$total_partially_paid_amount}</span> </td></tr>
                                <tr><td>Cancelled: </td> <td><span class="amount">{$total_cancelled_amount}</span> </td></tr>
                                <tr><td>&nbsp; </td> <td></td></tr>
                            ...
                            <h3>Total Unpaid Amount: <span class="amount">{$total_unpaid_amount}</span></h3>

                            {if $config['add_fund']}
                                <h3>Balance: <span class="amount">{$user->balance}</span></h3>
                                <h3>Due: <span class="amount">{$due_amount}</span></h3>
                            {/if}
