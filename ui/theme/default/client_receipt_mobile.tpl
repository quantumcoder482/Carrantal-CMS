...
<div class="container" style="margin-top: 40px;">
    <div class="row">
        <div class="col-md-6 col-xs-6">{$config['CompanyName']}</div>
        <div class="col-md-6 col-xs-6" style="text-align: right;">Date : {date('Y-m-d')}</div>
    </div>
</div>
...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-7 col-xs-7" style="text-align: right;">
            <img src="{$app_url}storage/system/logo.png" alt="Logo">
        </div>
