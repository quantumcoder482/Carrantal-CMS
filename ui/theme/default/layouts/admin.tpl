...
<head>
    ...
    <link href="{$theme}default/css/app.css" rel="stylesheet">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav nav-highlight" id="side-menu">
                    ...
                    {if APP_STAGE eq 'Dev'}
                        ...
                        <li {if $_application_menu eq 'dev'}class="active"{/if}><a href="{$_url}dev"><i class="fa fa-file-code-o"></i> <span class="nav-label">Developer</span></a></li>
