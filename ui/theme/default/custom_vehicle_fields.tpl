        ...
        <div class="col-md-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>{$_L['Custom Vehicle Fields']}</h5>
    ...
    <script>
        $(document).ready(function () {
            ...
            $modal.on('click', '#add_submit', function(){
                ...
                var _url = $("#_url").val();
                $.post(_url + 'settings/custom-vehicle-fields-post/', $('#add_form').serialize(), function(data){
            ...
            $modal.on('click', '#edit_submit', function(){
                ...
                var _url = $("#_url").val();
                $.post(_url + 'settings/custom-vehicle-field-edit-post/', $('#edit_form').serialize(), function(data){
