...
');
    ...
    case 'predefined_replies':
        ...
        $ui->assign('xfooter',
            Asset::js(array('modal','redactor/redactor.min','tickets/predefined_replies'))
        );
...
');
    ...
    case 'view':
        ...
        if($d){
            ...
            $ui->assign('xfooter',
                Asset::js(array('redactor/redactor','modal','dropzone/dropzone','tinymce/tinymce.min','js/editor','tickets/admin_view'))
            );
    ...
    case 'list':
        ...
        $ui->assign('xfooter',Asset::js(array('popover/popover','js/redirect','select/select.min','s2/js/select2.min','s2/js/i18n/'.lan(),'dt/dt','tickets/admin_list'))
        );
